...
namespace TriadCore
{
    ...
    public interface IStructExprStack
    {
        ...
        //Случайные графы
        void PushEmptyErdosRenyiGraph();
        void PushEmptyBaklyOktusGraph();
        void PushEmptyBollRiordanGraph();
        void PushEmptyCopyGraph();
    ...
    public class StructExprStack : IStructExprStack
    {
        ...
        {
            stack.Add(new ErdosRenyiGraph());
        }

        public void PushEmptyBaklyOktusGraph()
        {
            stack.Add(new BaklyOktusGraph());
        }

        public void PushEmptyBollRiordanGraph()
        {
            stack.Add(new BollobasRiordanGraph());
        }

        public void PushEmptyCopyGraph()
        {
            stack.Add(new CopyGraph());
        }
