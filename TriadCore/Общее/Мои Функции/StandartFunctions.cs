...
namespace TriadCore
{
    ...
    public static class StandartFunctions
    {
        ...
        public static Dictionary<CoreName,double> Clustering(Graph graph)
        {
            Dictionary<CoreName, double> res;
            ClusteringCoefficient cl = new ClusteringCoefficient();
            cl.Calculate(graph, out res);
            return res;
        }

        public static Dictionary<CoreName,int> NodesDegree(Graph graph)
        {
            Dictionary<CoreName, int> res = new Dictionary<CoreName, int>();
            foreach(Node n in graph.Nodes)
            {
                res.Add(n.Name, GetNodeDegree(n));
            }
            return res;
        }
