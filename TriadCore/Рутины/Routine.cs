...
namespace TriadCore
{
    ...
    public class Routine : ReflectionObject, ICreatable
    {
        ...
        /// </summary>
        protected SortedList<CoreName, List<CoreName>> routineNodePolusPairs = new SortedList<CoreName, List<CoreName>>();
        /// <summary>
        /// Список соответствий вида: Key - имя полюса в вершине; Value - имена связанных с ним полюсов в рутине
        /// </summary>
        protected SortedList<CoreName, List<CoreName>> nodeRoutinePolusPairs = new SortedList<CoreName, List<CoreName>>();
        /// <summary>
        ...
        // Мое ново введение для сетей Петри, но его в принципе можно развить дальше.
        // Просто с трансляции с Triad эти полюса теряются, а я хотел бы их использовать
        // Я их не связал еще с транслятором, но хотел бы
        // Дмитриев 

        protected List<CoreName> InputPolusesNames = new List<CoreName>();

        protected List<CoreName> OutputPolusesNames = new List<CoreName>();

        protected List<CoreName> InOutPolusesNames = new List<CoreName>();
    }
}
