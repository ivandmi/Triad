...
namespace ShowcaseApp.WPF.Models
{
    ...
    {
        private GraphAreaControl _graphArea;
        private ZoomControl _zoomControl;
        private EdgeBlueprint _edgeBp;

        public EditorObjectManager(GraphAreaControl graphArea, ZoomControl zc)
        {
        ...
        {
            _edgeBp = new EdgeBlueprint(source, mousePos, new SolidColorBrush(Colors.Black));
