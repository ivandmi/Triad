...
namespace TriadCompiler
    ...
    internal class KeyIdentificatorContainer
        ...
        private static void FillKeyIdentificatorTable()
            ...
            //Случайные графы
            keyIdentificatorTable.Add("ERGRAPH", Key.ERGraph);
            keyIdentificatorTable.Add("BRGRAPH", Key.BRGraph);
            keyIdentificatorTable.Add("BOGRAPH", Key.BOGraph);
            keyIdentificatorTable.Add("COPYGAPH", Key.CopyGraph);
            }
